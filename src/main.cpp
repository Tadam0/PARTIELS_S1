...
int main() {
  ...
  case 2:
    cout << "\n";
    cout << "Vous restituez un vélo." << endl;
		break;
  ...
  case 3:
    ...
    if (type == 1) {
      cout << "\n";
      cout << "Votre trajet coutera environ " << (trajet * coutHoraireMeca)/60 << " €" << endl;
    }
    if (type == 2) {
      cout << "\n";
      cout << "Votre trajet coutera environ" << (trajet * coutHoraireElec)/60 << " €" << endl;
    }
    break;
